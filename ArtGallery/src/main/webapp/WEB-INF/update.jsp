...
<body>
	...
	<form action="updateArtPiece.do">
		...
		<div class="input-group mb-3 container">
			<span class="input-group-text" id="basic-addon1">Description</span> <input
				type="text" name="artMovement" class="form-control"
				placeholder="Username" aria-label="Username"
				aria-describedby="basic-addon1" value="${art.artMovement}">
		</div>
		<div class="input-group mb-3 container">
			<span class="input-group-text" id="basic-addon1">Description</span> <input
		...
		<div class="input-group mb-3 container">
			...
			<select class="form-select" name="year" id="inputGroupSelect01"
				required>
